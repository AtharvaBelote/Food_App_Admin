      ...
      <View className="h-[50%] relative rounded-b-3xl overflow-hidden">
        ...
        <View className="absolute bottom-8 left-6">
          ...
          <Text className="text-white/90 mt-2 max-w-[300px]">
            Connect local hygienic mess services with hungry customers nearby.
          </Text>
        </View>
      </View>
      ...
      <View className="flex-1 px-6 justify-between pt-6">
        <View>
          <Text className="text-xl font-bold">
            Built to help customers to eat Healthy and Hygenic food to there door-step.
          </Text>
        </View>

        {/* Primary CTA */}
        <TouchableOpacity
          className="bg-primary rounded-full py-4 mb-12 shadow-xl flex-row justify-center items-center"
